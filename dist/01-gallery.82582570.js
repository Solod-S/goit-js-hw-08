...
var SimpleLightboxGallery = {
  gallery: document.querySelector(".gallery"),
  createGalleryMarkUpFrom: function createGalleryMarkUpFrom(galleryItems) {
    return galleryItems.map(function (_ref) {
      var preview = _ref.preview,
          original = _ref.original,
          description = _ref.description;
      return "<li class=\"gallery__li\">\n  <a class=\"gallery__item\" href=\"".concat(original, "\">\n  <img class=\"gallery__image\" src=\"").concat(preview, "\" alt=\"").concat(description, "\" />\n</a>\n</li> ");
    }).join("");
  }
};
var newGallery = SimpleLightboxGallery.createGalleryMarkUpFrom(_galleryItems.galleryItems); // новая галлерея === запуск функции создания разметки
